...
<head>
  ...
  <title>Evalexa | Add Result</title>
    ...
    <main class="flex-1 p-6 overflow-y-auto">
      <div class="mx-auto bg-gray-100 border border-gray-400 rounded-2xl shadow-xl p-8 space-y-6 w-full">
        ...
        <div class="flex justify-between items-center">
          <h3 class="text-lg font-semibold text-purple-600"><i class="fas fa-plus-circle mr-2"></i> Add New Result</h3>
          <a href="${pageContext.request.contextPath}/admin/result" class="text-sm text-purple-600 hover:underline">
            ← Back to Result List
          </a>
        </div>
        ...
        <form action="${pageContext.request.contextPath}/admin/result?action=create" method="POST" class="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="text" id="grade" name="grade" required readonly
                   ...
                   class="w-full px-4 py-2 bg-gray-200 border border-gray-300 rounded-lg text-sm text-gray-700 cursor-not-allowed" />
          </div>

          <!-- Submit -->
          <div class="md:col-span-2">
            <button type="submit"
                    class="w-full py-2 px-4 bg-purple-600 text-white font-semibold rounded-lg transition hover:bg-purple-500">
