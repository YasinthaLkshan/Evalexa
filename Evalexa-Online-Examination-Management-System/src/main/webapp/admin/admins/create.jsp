...
<body class="bg-gradient-to-b from-purple-400 via-blue-300 to-white text-gray-900 min-h-screen flex">
  ...
  <div class="flex-1 md:ml-60 flex flex-col min-h-screen">
    ...
    <main class="flex-1 p-6 overflow-y-auto">
      <div class="mx-auto bg-gray-100 border border-gray-400 rounded-2xl shadow-xl p-8 space-y-6 w-full">

        <div class="flex justify-between items-center">
          <h3 class="text-lg font-semibold text-purple-600"><i class="fas fa-user-plus mr-2"></i> Create New Admin</h3>
          <a href="${pageContext.request.contextPath}/admin/admin" class="text-sm text-purple-600 hover:underline">
            ← Back to Admin List
          </a>
        </div>

        <form action="${pageContext.request.contextPath}/admin/admin?action=create" method="POST" class="grid gap-6">
          <!-- Full Name -->
          <div>
