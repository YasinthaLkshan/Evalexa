...
<head>
    ...
    <title>Evalexa | Manage Admins</title>
        ...
        <main class="flex-1 p-6 overflow-hidden">
            <div class="bg-gray-100 border border-gray-400 rounded-2xl shadow-xl h-full overflow-hidden flex flex-col">
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-400">
                    <h3 class="text-lg font-semibold text-purple-600"><i class="fas fa-user-shield mr-2"></i>All Admins</h3>
                            ...
                            <c:forEach var="admin" items="${admins}">
                                <tr class="hover:bg-gray-200/40 transition">
                                    ...
                                    <td class="px-6 py-4 space-x-3">
                                        <a href="${pageContext.request.contextPath}/admin/admin?action=edit&id=${admin.admin_id}"
                                           class="text-purple-600 hover:text-purple-500" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="${pageContext.request.contextPath}/admin/admin?action=delete&id=${admin.admin_id}"
