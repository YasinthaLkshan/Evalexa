    ...
    <main class="flex-1 p-6 overflow-y-auto">
      <div class="mx-auto bg-gray-100 border border-gray-400 rounded-2xl shadow-xl p-8 space-y-6 w-full">
        ...
        <div class="flex justify-between items-center">
          <h3 class="text-lg font-semibold text-purple-600"><i class="fas fa-file-alt mr-2"></i> Create New Exam</h3>
          <a href="${pageContext.request.contextPath}/admin/exam" class="text-sm text-purple-600 hover:underline">
            ← Back to Exam List
          </a>
        </div>
