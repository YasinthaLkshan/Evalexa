...
<head>
    ...
    <title>Evalexa | My Results</title>
        ...
        <main class="flex-1 p-6 overflow-hidden">
            <div class="bg-gray-100 border border-gray-400 rounded-2xl shadow-xl h-full overflow-hidden flex flex-col">
                <div class="px-6 py-4 border-b border-gray-400">
                    <h3 class="text-lg font-semibold text-purple-600"><i class="fas fa-file-alt mr-2"></i>My Exam Results</h3>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-700">
                            <c:forEach var="result" items="${results}">
                                <tr class="hover:bg-gray-200/40 transition">
                                    ...
                                    <td class="px-6 py-4 font-semibold text-purple-600">${result.grade}</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
