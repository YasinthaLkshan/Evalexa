...
<head>
    ...
    <title>Evalexa | My Enrollments</title>
            ...
            <div class="bg-gray-100 border border-gray-400 rounded-2xl shadow-xl h-full overflow-hidden flex flex-col">
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-400">
                    <h3 class="text-lg font-semibold text-purple-600">
                        <i class="fas fa-list-check mr-2"></i>My Exam Enrollments
                    </h3>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-700">
                            <c:forEach var="enrollment" items="${enrollments}">
                                <tr class="hover:bg-gray-200/40 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="${pageContext.request.contextPath}/student/enrollments?action=delete&id=${enrollment.enrollment_id}"
                                           onclick="return confirm('Are you sure you want to cancel this enrollment?');"
                                           class="text-red-600 hover:text-red-600" title="Cancel Enrollment">
