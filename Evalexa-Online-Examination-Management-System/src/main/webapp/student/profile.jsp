...
<div class="flex-1 md:ml-60 flex flex-col min-h-screen">
    ...
    <main class="flex-1 p-6 overflow-auto">
        <div class="mx-auto w-full bg-gray-100 border border-gray-400 rounded-2xl shadow-xl p-8 space-y-6">

            <h3 class="text-lg font-semibold text-purple-600 text-center">
            ...
            <form method="POST" action="${pageContext.request.contextPath}/student/profile" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" required value="${student.password}"
                           class="w-full px-4 py-2 bg-gray-200 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-purple-500"/>
                    <div class="mt-2 ml-1 text-xs text-gray-700 space-y-1">
                ...
                <div class="text-center">
                    <button id="submitBtn" type="submit"
                            class="inline-flex items-center px-6 py-2 bg-purple-600 text-white text-sm font-semibold rounded-lg opacity-50 cursor-not-allowed transition">
